...
<div class="container-fluid py-4 admin-content">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h4 text-white mb-0">Notifications</h1>
    ...
    <div class="card admin-card admin-card-hover">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-white fw-semibold">System Notifications</div>
                <a class="btn btn-sm admin-btn-accent" href="<?= Config::get('app.base_path') ?>/admin">Back to Dashboard</a>
            </div>
        </div>
        <div class="card-body text-white">
            <div class="alert alert-info mb-0">
                This page is ready. Hook it to admin notification logs when available.
            </div>
        </div>
    </div>
</div>
